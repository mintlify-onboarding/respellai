...
From here, you’ll be in the our Spell Studio! This is a drag & drop no-code editor. To get started, click on a ‘input’ block and attach it to a model and output. You can learn more about each block type in the [Block Types 🪄](/docs/block-types) section.
